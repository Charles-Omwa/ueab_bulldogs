...
class AddFixtureDialog {
  ...
  Widget buildAboutDialog(BuildContext context,
    ...
    if (user != null) {
      ...
      teStart_stop.text = user.start_stop;
      ...
      content: new SingleChildScrollView(
        child: new Column(
          ...
          children: <Widget>[
            ...
            getTextField("Start   Stop", teStart_stop),
...
//            ),
  ...
  Fixture getData(bool isEdit) {
    return new Fixture(isEdit ? user.id : "", teMatch.text, teHometeam.text,
        teAwayteam.text, teStart_stop.text, teQuater.text);
  }
